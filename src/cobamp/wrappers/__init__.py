...
from .core import MatFormatReader, CobampModelObjectReader
...
available_readers_dict = {'cobra.core.model': 'COBRAModelObjectReader',
...
# class DeprecationContainer():
# 	def update_dict(self, args):
# 		self.__dict__.update(args)
#
# external_wrappers = DeprecationContainer()
# external_wrappers.update_dict(external_framework_readers)
# external_wrappers.update_dict({get_model_reader.__name__: get_model_reader})
